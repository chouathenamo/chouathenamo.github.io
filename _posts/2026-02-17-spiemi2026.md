...
- Demonstrated that equential fine-tuning with PEL outperforms joint optimization, achieving 8.8% RMSE improvement on the external test set over the baseline.
